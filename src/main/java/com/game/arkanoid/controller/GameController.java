...
import com.game.arkanoid.view.renderer.*;
...
public final class GameController {
    ...
    private final java.util.List<GameEventBus.Subscription> subscriptions = new ArrayList<>();
    ...
    private void registerEventListeners() {
        subscriptions.add(GameEventBus.i().subscribe(LevelClearedEvent.class, this::onLevelCleared));
    }
